...
class DiariosRelationManager extends RelationManager
{
    protected static string $relationship = 'diarios';

    protected static ?string $title = 'Diário de acompanhamento';
    ...
    public function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('area')->label('Área')->badge()->sortable(),
